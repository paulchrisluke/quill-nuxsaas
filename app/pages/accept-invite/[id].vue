  ...
  <div class="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
    <UCard class="w-full max-w-md">
      <div class="text-center">
        <h1 class="text-xl font-semibold mb-4">Accepting Invitation</h1>
        ...
        <div v-else-if="error" class="text-red-500 mb-4">
          <UIcon name="i-lucide-alert-circle" class="h-12 w-12 mx-auto mb-2" />
          <p>{{ error }}</p>
          <UButton to="/" class="mt-4" variant="outline">Go Home</UButton>
        </div>

        <div v-else>
          <UIcon name="i-lucide-check-circle" class="h-12 w-12 mx-auto mb-2 text-green-500" />
