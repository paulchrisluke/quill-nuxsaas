ALTER TABLE "user" ALTER COLUMN "default_organization_id" DROP DEFAULT;
--> statement-breakpoint
ALTER TABLE "user" ALTER COLUMN "default_organization_id" DROP NOT NULL;
--> statement-breakpoint
UPDATE "user" AS u
...
ALTER TABLE "user" DROP CONSTRAINT IF EXISTS "user_default_organization_id_organization_id_fk";--> statement-breakpoint
